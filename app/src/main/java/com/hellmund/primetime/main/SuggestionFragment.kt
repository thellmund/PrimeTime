...
class SuggestionFragment : Fragment() {
    ...
    private fun updateWatchlistButton(watchStatus: ApiMovie.WatchStatus) {
        setButtonText(watchStatus)
        setButtonColor(watchStatus)
    }

    private fun setButtonText(watchStatus: ApiMovie.WatchStatus) {
        val textResId = when {
    ...
    private fun setButtonColor(watchStatus: ApiMovie.WatchStatus) {
